...
public enum DamageApplicationBucket {
     ...
     */
    VANILLA_MELEE_BASE(true, true, false, true, true, true, true),

    /**
     * Sharpness / Smite / Bane delta.
     * Eats vanilla melee cooldown and usually crit according to the current DN table.
     */
    VANILLA_MELEE_ENCHANTMENT(true, true, false, true, true, true, true),

    /**
     * Mace fall bonus, spear speed bonus.
     * Vanilla-specific behavior. By default it remains mitigated.
     */
    VANILLA_WEAPON_SPECIAL(true, true, false, true, true, true, true),

    VANILLA_PROJECTILE_BASE(false, false, false, true, true, true, true),

    VANILLA_PROJECTILE_ENCHANTMENT(false, false, false, true, true, true, true),

    VANILLA_PROJECTILE_CRIT_BONUS(false, false, false, false, true, true, true),
     ...
     */
    DN_TRUE_DAMAGE(false, false, false, true, false, false, false);
    ...
    DamageApplicationBucket(
            ...
            boolean affectedByGenericPreMultiplier,
        ...
        this.affectedByChannelPreMultiplier = affectedByGenericPreMultiplier;
        this.affectedByGlobalPreMultiplier = affectedByGenericPreMultiplier;
